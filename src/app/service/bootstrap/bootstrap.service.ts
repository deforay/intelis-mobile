              ...
              this.webSamplesArray.forEach(
                function (item) {
                  if (item.appSampleCode != null) {
                    ...
                    data.push(item.rejectionDate);
                    data.push(item.sampleDispatchedOn);
                    data.push(item.clinicianName);
                    data.push(item.locationOfSampleCollection);
                    data.push(item.reasonForRepeatPcrOther);
                  }
